...
# Creating the list of available EBS volumes
listOut = []
...
<body>
    <font size=+1><i>These are the available EBS volumes found in QA environments and are scheduled for deletion every Friday at 01:00AM UTC.
    Please review and take any necessary actions before then.</i></font>
<br>
<br>
    <font size=+2>Available EBS volumes in QA environments</font>
<br>
<br>
    <table>\n
      <tr>
...
display = open("ListAvailableEBS.html", 'w')
